...
function updateStatus() {
  ...
  let isOpen = false;
  // Horaires: Mer 17h30–02h, Jeu-Sam-Dim 17h30–03h, Ven 17h30–04h, Lun-Mar fermé
  ...
  // After midnight portion: Mer close at 02h (120min), Jeu,Sam,Dim close at 03h (180min), Ven close at 04h (240min)
  ...
  } else if ([0,4,6].includes(prevDay) && t < 180) {
    isOpen = true; // after midnight, prev day was Jeu/Sam/Dim → open until 03h
  } else if (prevDay === 5 && t < 240) {
    isOpen = true; // after midnight, prev day was Ven → open until 04h
  }
  ...
  if (isOpen) {
    ...
    if (openEvening.includes(day) && t >= 1050) {
      ...
      else if ([0,4,6].includes(day)) closeTime = '03h';
      else if (day === 5) closeTime = '04h';
    } else if (prevDay === 3 && t < 120) { closeTime = '02h';
    } else if ([0,4,6].includes(prevDay) && t < 180) { closeTime = '03h';
    } else if (prevDay === 5 && t < 240) { closeTime = '04h'; }
